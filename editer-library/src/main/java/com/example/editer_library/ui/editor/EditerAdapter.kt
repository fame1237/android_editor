package com.example.editer_library.ui.editor
...
import com.example.editer_library.ScreenUtil.createIndentedText
import com.example.editer_library.ScreenUtil.dpToPx
import com.example.editer_library.StyleCallback
import com.example.editer_library.extension.filterGetArrayIndex
import com.example.editer_library.extension.filterGetIndex
...
//                    (context as EditerActivity).hideKeyboard()
    ...
    inner class MyEditTextIndentViewHolder(
        ...
        RecyclerView.ViewHolder(v) {
        var edt = v.findViewById<com.example.editer_library.view.MyEditText>(R.id.edt)
        var myCustomEditTextListener = customEditTextListener
    ...
    inner class MyQuoteViewHolder(v: View, customEditTextListener: MyCustomEditTextListener) :
        RecyclerView.ViewHolder(v) {
        var edtQuote = v.findViewById<com.example.editer_library.view.MyEditText>(R.id.edtQuote)
        var myCustomEditTextListener = customEditTextListener
    ...
    inner class MyImageViewHolder(
        ...
        var edtImage = v.findViewById<com.example.editer_library.view.MyEditText>(R.id.edtImage)
        var myCustomEditTextListener = customEditTextListener
    ...
    inner class MyCustomImageLayoutEditTextListener : TextWatcher,
        com.example.editer_library.view.EditTextSelectable.onSelectionChangedListener,
